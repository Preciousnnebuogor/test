...
export default function HomePage() {
  return (
    <div className={`md:grid md:grid-cols-2 md:space-x-6 text-black px-4 `}>
      <div className={`md:flex  md:items-center md:justify-center pt-4 md:pt-0`}>
        <div className={`md:[w-70%] md:mt-10 mt-4`}>
          ...
          <div className={` bg-slate-200 px-2 w-[100%]`}>
            ...
            <div className={`grid grid-cols-3 bg-slate-200`}>
              <div>
                ...
                <img src="/img0.png" alt="" className={`w-[50px] h-[50px]  `} />
              </div>
              <div>
          ...
          <div className={`w-[100%] bg-slate-200 mt-4 pt-2 pb-2`}>
            ...
            <div className={`grid grid-cols-3 px-4  text-xs`}>
              <div>
                <h1 className={`rounded bg-white`}></h1>
                <p>white</p>
              </div>
              <div>
                <h1 className={`bg-blue-600 rounded`}></h1>
                <p>blue</p>
              </div>
              <div>
                <h1 className={`bg-blue-600 rounded`}></h1>
      ...
      <div className={`mt-10 w-[90%]`}>
        ...
        <div>
          ...
          <div className={`flex justify-start space-x-5 pt-2 `}>
            ...
            <p className={`border-2 border-slate-200 rounded-full px-3`}>XL</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className={`flex items-start justify-between`}>
            <button className={`border-2 border-black rounded px-16 pt-3 mt-3`}>
              - 1 +
            </button>
          ...
          <p className={`text-bold mt-3`}>Guaranteed SAFE Checkout</p>
          <div className={`flex items-start space-x-2`}>
